            ...
            <div class="editContainer" style="padding-left: 3%; padding-right: 3%">
                ...
                <form name="install" id="editLicense" method="POST" action="index.php" class="form-horizontal">
                    ...
                    <div id="step1" class="padding1per" style="border:1px solid #ccc; padding-left: 10px; padding-bottom: 10px">
                        ...
                        <div class="controls">
                            <div>
                                <p>{vtranslate('LBL_DOWNLOAD_SRC_DESC1', $MODULE)}</p>
                                <input type="url" value="{$PDF_LIB_LINK}" disabled="disabled" style="width: 30%;"/>
                                <p style="padding-top: 5px">{vtranslate('LBL_DOWNLOAD_SRC_DESC2', $MODULE)}</p>
                                <input type="text" value="{$PDF_LIB_SOURCE}" disabled="disabled" style="width: 30%"/>

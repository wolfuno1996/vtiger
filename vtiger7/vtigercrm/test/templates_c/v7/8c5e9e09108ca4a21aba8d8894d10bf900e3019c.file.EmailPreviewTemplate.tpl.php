<?php /* Smarty version Smarty-3.1.7, created on 2018-04-06 04:03:53
         compiled from "F:\vTiger\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\QuotingTool\EmailPreviewTemplate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:231025ac6132024e979-66325314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c5e9e09108ca4a21aba8d8894d10bf900e3019c' => 
    array (
      0 => 'F:\\vTiger\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\QuotingTool\\EmailPreviewTemplate.tpl',
      1 => 1522987419,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '231025ac6132024e979-66325314',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5ac613203f7c6',
  'variables' => 
  array (
    'MODULE' => 0,
    'TRANSACTION_ID' => 0,
...
<?php if ($_valid && !is_callable('content_5ac613203f7c6')) {function content_5ac613203f7c6($_smarty_tpl) {?>
...
"style="width: 98%;"/></div></div><div id="multiEmailContainer"><?php if ($_smarty_tpl->tpl_vars['EMAIL_FIELD_LIST']->value){?><?php echo var_dump($_smarty_tpl->tpl_vars['EMAIL_FIELD_LIST']->value);?>
<?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable(0, null, 0);?><?php $_smarty_tpl->tpl_vars['allEmailArr'] = new Smarty_variable(array(), null, 0);?><?php  $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL']->_loop = false;
...
$_smarty_tpl->tpl_vars['allEmailArr']->value[$_smarty_tpl->tpl_vars['i']->value] = $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL']->value;?><?php if ($_smarty_tpl->tpl_vars['MUPTIPLE_EMAIL']->value){?><?php  $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->_loop = false;
 $_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME1'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->key => $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->value){
$_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->_loop = true;
 $_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME1']->value = $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->key;
?><div class="control-group" style="margin-left: 25px; margin-bottom: 10px"><label class="checkbox"><input type="checkbox" class="emailField" name="selectedEmail[<?php echo $_smarty_tpl->tpl_vars['i']->value++;?>
]" value='<?php echo $_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME1']->value;?>
' /><span style="padding-left: 10px"><?php echo $_smarty_tpl->tpl_vars['EMAIL_FIELD_LABEL1']->value;?>
</span></label></div><?php } ?><?php }else{ ?><div class="control-group" style="margin-left: 25px; margin-bottom: 10px"><label class="checkbox"><input type="checkbox" class="emailField" name="selectedEmail[<?php echo $_smarty_tpl->tpl_vars['i']->value++;?>
...
</span></label></div><?php }?><?php } ?><div class="control-group clearfix" style="margin-bottom: 10px"><div class="pull-left"><input type="hidden" class="span4 form-control select2 select2-tags"name="ccValues" data-tags='<?php echo json_encode($_smarty_tpl->tpl_vars['allEmailArr']->value);?>

                ...
                {if $TEMPLATE_TOTAL == 0}
                    <li>
                        <a href="index.php?module=QuotingTool&view=Edit&primary_module={$SOURCE_MODULE}"
                           ...
                           class="webMnu">
                            <img src="layouts/v7/modules/QuotingTool/resources/img/icons/widget-add-template.png"
                ...
                {else}
                    <li>
                        <a href="javascript:;"
                           data-action="export"
                           class="webMnu">
                            <img src="layouts/v7/modules/QuotingTool/resources/img/icons/widget-pdf.png"
                                 hspace="5" align="absmiddle" border="0" style="border-radius:3px;">
                    ...
                    <li>
                        <a href="javascript:;"
                           ...
                           class="webMnu">
                            <img src="layouts/v7/modules/QuotingTool/resources/img/icons/widget-mail.png"
                                 hspace="5" align="absmiddle" border="0" style="border-radius:3px;">
                    ...
                    {*<li>*}
                        {*<a href="javascript:;"*}
                           ...
                           {*class="webMnu">*}
                            {*<img src="layouts/v7/modules/QuotingTool/resources/img/icons/widget-download.png"*}
                                 {*hspace="5" align="absmiddle" border="0" style="border-radius:3px;">*}

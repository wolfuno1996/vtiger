...
{strip}
    ...
    <div class="row">
        ...
        <div class="span6" style="padding: 15px; width: 45%">
            ...
            <p data-toggle="tooltip" {if $PHPZIP eq 'installed'} hidden{/if} data-placement="bottom" title="php-gd is php extension is required to import/load default templates. If you are creating your own template, you don't need to install this." style="width: 100px; float: left;font-weight: bold; margin-left: 10px">

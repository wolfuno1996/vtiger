                ...
                <div class="tab-pane" id="relatedTabContent">
                    ...
                    <span class="span7 row-fluid">
                        <span style="margin-top: 7px"
                              class="span2">{vtranslate('LBL_ADD_FIELD',$QUALIFIED_MODULE)}</span>&nbsp;&nbsp;
                        <span class="span8">
                            <select style="min-width: 250px" id="task-fieldnames" class="chzn-select"
                                    data-placeholder={vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}>
                                <option></option>
                                {$ALL_FIELD_OPTIONS}
                            </select>
                    ...
                    <span class="span5 row-fluid">
                        ...
                        <span class="span8">
                            <select style="width: 215px" id="task_timefields" class="chzn-select"
                                    data-placeholder={vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}>
                                <option></option>
